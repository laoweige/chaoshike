...
<footer class="footer">
	...
	<ul class="list-ui-index foot-list tc">
		<li>
			...
			<a  href="javascript:void(0)" id="shopCartTip"  class="foot3">购物车</a>
		</li>
		<li><a  href="http://www.suning.com/emall/tcd_10052_10051_.html" class="foot4">电脑版</a><a href="javascript:void(0)"  id="suningapp" class="foot5">客户端</a></li>
	</ul>
	<div class="tc copyright">Copyright© 2002-2014 m.suning.com</div>
</footer>