...
public class DateUtil {
	public static final String TIME_PATTERN_23 = "yyyy-MM-dd HH:mm:ss.SSS";
	public static final String TIME_PATTERN_19 = "yyyy-MM-dd HH:mm:ss";
	public static final String TIME_PATTERN_10 = "yyyy-MM-dd";
	...
	public static Date fmtStrToDate(String dtFormat) {
		...
		try {
			if (dtFormat.length() == 10) {
				dtFormat = dtFormat + " 00:00:00.000";
			} else if (dtFormat.length() == 19) {
				dtFormat = dtFormat + ".000";
			} else if (dtFormat.length() == 23) {

			} else {
				//return null;
			}

			SimpleDateFormat dateFormat = new SimpleDateFormat(TIME_PATTERN_23);
	...
	/**
	 * Description:Date转化为yyyy-MM-dd HH:mm:ss.SSS的String
	 * 
	 * @param date
	 * @param dtFormat
	...
	/**
	 * Description:Date转化为dtFormat的String
	 * 
	 * @param date
	 * @param dtFormat
	 *            例如:yyyy-MM-dd HH:mm:ss yyyyMMdd
	...
	public static Date toShortDate(Date date) {
		String strD = fmtDateToStr(date, TIME_PATTERN_10);
...
//		Date date = fmtStrToDate("2013-11-30 18:52:03");
//		SimpleDateFormat format = new SimpleDateFormat("yyMMdd");
//		System.out.println(format.format(addDay(date, 1)));
		System.out.println(DateUtil.fmtDateToStr(DateUtil.fmtStrToDate("2013-11-30 18:52:03"), "yyyy-MM-ddTHH:mm:ssZ"));
	}
}